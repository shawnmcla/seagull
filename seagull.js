...
["_main","_memory","_updateBitmap","_getCurrentGrid","_getBitmap","_getGridWidth","_getGridHeight","_getGeneration","_setGeneration","_setCell","_getCell","_showGrid","_step","_init","_cleanup","___indirect_function_table","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
if (Module['locateFile']) {
  ...
  wasmBinaryFile = new URL('seagull.wasm', import.meta.url).href;
}
...
var _getCell = Module['_getCell'] = createExportWrapper('getCell');
